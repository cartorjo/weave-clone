...
function management() {
  // Photos where supplied; initials tiles for members without a portrait.
  ...
  const gallery = [
    ...
    {name:'Dr. Michael Schmitt', initials:'MS'},
    {name:'Marcus Hefele', initials:'MH'},
  ];
